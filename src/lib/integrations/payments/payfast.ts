...
export function buildPayfastCheckoutForm(input: CreateCheckoutInput): PayfastCheckoutForm {
  ...
  const data: Record<string, string> = {
    ...
    ...(input.nameFirst ? { name_first: input.nameFirst.slice(0, 100) } : {}),
    ...(input.nameLast ? { name_last: input.nameLast.slice(0, 100) } : {}),
    ...(input.emailAddress ? { email_address: input.emailAddress.slice(0, 100) } : {}),
    ...(input.cellNumber ? { cell_number: input.cellNumber.slice(0, 100) } : {}),
