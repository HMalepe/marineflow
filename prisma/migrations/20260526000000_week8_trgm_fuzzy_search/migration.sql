...
CREATE INDEX IF NOT EXISTS "Customer_firstName_trgm_idx" ON "Customer"
  USING gin ("firstName" gin_trgm_ops);

CREATE INDEX IF NOT EXISTS "Customer_lastName_trgm_idx" ON "Customer"
  USING gin ("lastName" gin_trgm_ops);

CREATE INDEX IF NOT EXISTS "Customer_displayName_trgm_idx" ON "Customer"
  USING gin ("displayName" gin_trgm_ops);

CREATE INDEX IF NOT EXISTS "Customer_email_trgm_idx" ON "Customer"
  USING gin (email gin_trgm_ops);

CREATE INDEX IF NOT EXISTS "Customer_waId_trgm_idx" ON "Customer"
